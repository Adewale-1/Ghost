...
def is_gartley_pattern(lines, error_allowed):
    ...
    BC_range = np.array([0.382 - error_allowed, 0.886 + error_allowed]) * abs(XA)
    CD_range = np.array([1.27 - error_allowed, 1.618 + error_allowed]) * abs(XA)
...
def is_butterfly_pattern(lines, error_allowed):
...
def is_bat_pattern(lines, error_allowed):
    # print("Bat Pattern")
    XA = lines[0]
    AB = lines[1]
    BC = lines[2]
...
def is_crab_pattern(lines, error_allowed):
    # print("Crab Pattern")
    XA = lines[0]
    AB = lines[1]
    BC = lines[2]
...
def is_cypher_pattern(lines, error_allowed):
    ...
    AB_range = np.array([0.382 - error_allowed, 0.618 + error_allowed]) * abs(XA)
    BC_range = np.array([1.272 - error_allowed, 1.414 + error_allowed]) * abs(AB)
    CD_range = np.array([1.618 - error_allowed, 2.618 + error_allowed]) * abs(BC)
